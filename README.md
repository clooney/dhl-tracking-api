...
In order to use this API, you need to generate a DHL Tracking  API key in the [TrackingMore](https://www.trackingmore.com).
...
------------------------------------------------------------------------------------------------------------------
[TrackingMore](https://www.trackingmore.com) offers multiple carrier solutions. Developers can get tracking results from 410+ couriers by integrating trackingmore API. Using Trackingmore DHL Tracking API allows eCommerce developers in any sizes to add package tracking fuction easily. Use [DHL Tracking API](https://www.trackingmore.com/dhl-tracking.html)  to:

   *   Get DHL realtime tracking info of muti-carriers in one integration
   *   Provide DHL shipment tracking experience like Amazon
   *   Push DHL  notifications of package update with webhook
   *   Verify DHL delivery exception before it is too late
