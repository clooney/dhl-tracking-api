DHL Tracking API - Java
================================
Use Java to track DHL shipments with DHL Tracking API.
...
Create a tracking (Real-time tracking):
    ...
    package com.trackingmore.example.dhl;
    ...
    public class CreateDHLTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                createTrackingParams.setTrackingNumber("6832928535");
                createTrackingParams.setCourierCode("dhl");
...
Create trackings (Max. 40 tracking numbers create in one call):
    ...
    public class CreateDHLTrackingsExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                createTrackingParams1.setTrackingNumber("1895711370");
                createTrackingParams1.setCourierCode("dhl");
                
                CreateTrackingParams createTrackingParams2 = new CreateTrackingParams();
                createTrackingParams2.setTrackingNumber("1895711156");
                createTrackingParams2.setCourierCode("dhl");
...
Get status of the shipment:
    ...
    public class GetDHLTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                # trackingParams.setTrackingNumbers("1895711370,1895711156");
                trackingParams.setCourierCode("dhl");
...
Update a tracking by ID:
    ...
    public class UpdateDHLTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                String idString = "99e567a0cbdabf3660b788d850981c81";
