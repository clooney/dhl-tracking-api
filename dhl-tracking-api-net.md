DHL Tracking API - .Net
================================
Use .Net to track DHL shipments with DHL Tracking API.
      ...
      public class Test
      {
            ...
            static void Main(string[] args)
            {
              try
              {
                  ...
                  createTrackingParams.trackingNumber = "6832928535";
                  createTrackingParams.courierCode = "dhl";
      ...
      public class Test
      {
            ...
            static void Main(string[] args)
            {
              try
              {
                  ...
                  # getTrackingResultsParams.trackingNumbers = "1895711370,1895711156";
                  getTrackingResultsParams.courierCode = "dhl";
